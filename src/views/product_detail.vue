<template>
      <div class="d-flex justify-content-center" v-if="!load_products">
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-6 " >
            ...
            <div class="btn-group me-auto">
                ...
                <button class="btn btn-outline-primary" @click="decrement_quantity()" :disabled="quantity == 0">ลบสินค้า</button>
            </div>
            <button class="btn btn-outline-primary" @click="cart_store.add_cart_detail(product.id,product.price,quantity)">เพิ่มสินค้า</button>
        </div>
        </div>
